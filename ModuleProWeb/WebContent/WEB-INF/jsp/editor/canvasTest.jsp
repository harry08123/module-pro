...
<style>
	...
	.rectnumber{border-right: 1px solid #ccc;}
</style>


<link href="//code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css" rel="stylesheet">
<link type="text/css" href="<c:url value='/css/colorpicker.css'/>" rel="stylesheet">
<link type="text/css" href="<c:url value='/css/jquery.contextMenu.css'/>" rel="stylesheet"/>
		...
		//선 그리기
			...
			if(lineFirstSx == -1 && lineFirstSy == -1){
				...
				if((lineFirstSx < sx+lineGap && lineFirstSx > sx-lineGap) && (lineFirstSy < sy+lineGap && lineFirstSy > sy-lineGap)){
					...
					var tag = "<tr>"+
							  "<td class='rectnumber'>"+rectNames+"</td>"+
							  "<td class='rectnumber' id='area' style='text-align: right;'>"+Math.round(area)+"</td>"+
							  "<td class='rectnumber' style='text-align: right;'>"+density+"%</td>"+
	...
	<table>
		<tr>
			<td valign="top" id="colorpicker">
				...
				<button id="btnP" onclick="zoomIn('0.1', 'printDIV')">+</button>
				<button id="btnM" onclick="zoomOut('-0.1', 'printDIV')">-</button>
				</div> -->
				<br/><br/>
			...
			<td valign="top">
				<div style="width: 1000px; height: 800px; overflow: scroll; border: 1px solid;">
					<div id="printDIV">
			...
			<td valign="top" width="25%">
				<form id="projectForm">
					...
					<table>
						<tr>
							<th>Iteration</th>
							<td><input type="text" name="proIterNum" value="${project.PRO_ITERNUM}" style="text-align: right; width: 60px;"></td>
						</tr>
						<tr>
							<th>Setting Time</th>
							<td><input type="text" name="proStartTime" value="${project.PRO_STARTTIME}" style="text-align: right; width: 60px;"></td>
						</tr>
						<tr>
							<th>Life Time</th>
							<td><input type="text" name="proLifeTime" value="${project.PRO_LIFETIME}" style="text-align: right; width: 60px;"></td>
						</tr>
						<tr>
							<th>of Time Division/Year</th>
							<td><input type="text" name="proTd" value="${project.PRO_TD}" style="text-align: right; width: 60px;"></td>
						</tr>
						<tr>
							<td colspan="2" align="right"><button id="runSimulationBtn">Run Simulation</button></td>
						</tr>
						<tr>
							<th>Total Availability</th>
							<td id="totAvailability"></td>
						</tr>
					</table>
				</form>
				<br><br><br>
				<table style="border: 1px solid #ccc; margin-left: 20px; width: 100%;">
					<thead>
						<tr>
							<th colspan="4" style="border-bottom: 1px solid #ccc;">중복 범위 작업밀도</th>
						</tr>
						<tr>
							<th style="border-bottom: 1px solid #ccc; width: 100px;">중복 명</th>
							<th style="border-bottom: 1px solid #ccc; width: 50px;">면적</th>
							<th style="border-bottom: 1px solid #ccc; width: 67px;">밀도</th>
							<th style="border-bottom: 1px solid #ccc; width: 30px;">삭제</th>
						</tr>
					</thead>
					<tbody id="density">
					</tbody>
...
<div style="display: none;">
	<form id="propertiesForm" name="propertiesForm" action="">
		...
		<input type="hidden" name="figMoUid" value="">
